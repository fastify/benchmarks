...
const packages = {
  ...
  'mini-express-server': { package: "mini-express-server", hasRouter: true },
  'mini-express-server-with-middlewares': { extra: true, package: 'mini-express-server', hasRouter: true },
  'mini-express-server-big-json': { extra: true, package: 'mini-express-server', hasRouter: true },
}
